...
describe('TimeParser', () => {
    ...
    describe('generateAutoNotifyDate', () => {
        ...
        it('should generate notification time with simple time format', () => {
            const result = TimeParser.generateAutoNotifyDate('09:30 Daily standup', moment('2023-07-04'), null, true);
        ...
        it('should return null if no base date available (no filename date)', () => {
            const result = TimeParser.generateAutoNotifyDate('15:00 - 16:00 Meeting', null, null, true);
