...
description includes \
    ...
    const filters: ReadonlyArray<string> = [
        ...
        'no tags',
        'not done',
        'notify after 2021-12-27',
        'notify before 2021-12-27',
        'notify date is invalid',
        'notify in 2021-12-27 2021-12-29',
        'notify on 2021-12-27',
        'notify this week',
