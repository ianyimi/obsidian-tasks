    ...
    describe('serialize', () => {
        ...
        it('should serialize a fully populated task', () => {
            ...
            expect(serialized).toMatchInlineSnapshot(
                `"Do exercises #todo #health  [id:: abcdef]  [dependsOn:: 123456,abc123]  [priority:: medium]  [repeat:: every day when done]  [onCompletion:: delete]  [created:: 2023-07-01]  [start:: 2023-07-02]  [scheduled:: 2023-07-03]  [notify:: 2023-07-04]  [due:: 2023-07-05]  [cancelled:: 2023-07-07]  [completion:: 2023-07-06] ^dcf64c"`,
            );
        });
    });
});
